// =================================================================================
// ORACLE, ODBC and DB2/CLI Template Library, Version 4.0.257,
...
#define OTL_VERSION_NUMBER (0x040101L)
...
int ACIBreak(void*,void*);
int ACILobLocatorIsInit (void*,void*,void*,void *);
int ACIPasswordChange(void*,void*,void*,int,void*,int,void*,int,int);
int ACILobIsOpen(void*,void*,void*,void*);
int ACILobClose(void*,void*,void*);
int ACITerminate(int);
...
#if defined(OTL_ORA8) && !defined(OTL_OSCAR)
#include <oci.h>
#endif
